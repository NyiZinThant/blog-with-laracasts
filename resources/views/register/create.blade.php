        ...
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 rounded-xl p-6">
            ...
            <form action="/register" method="post" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" class="border border-gray-400 w-full p-2"
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="password" id="password" class="border border-gray-400 w-full p-2"
                        required>
                    @error('password')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
